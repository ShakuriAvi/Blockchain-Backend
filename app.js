...
const createSignedBlockchain = () => {
    ...
    bChain.chain[0] = new Block(
        1,
        0,
        trans1,
        "",
        new Coinbase("100", publicKey),
        keyPair
    );
    bChain.chain[0].mineBlock(4);
    bChain.addBlock(
        new Block(2, 0, trans2, "", new Coinbase("100", publicKey), keyPair)
    );
    bChain.addBlock(
        new Block(3, 0, trans3, "", new Coinbase("100", publicKey), keyPair)
    );
    bChain.addBlock(
        new Block(4, 0, trans4, "", new Coinbase("100", publicKey), keyPair)
    );
